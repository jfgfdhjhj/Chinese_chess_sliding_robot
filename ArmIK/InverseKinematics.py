...
class IK:
    # 舵机从下往上数
    # 公用参数，即4自由度机械臂的连杆参数
    # l1 = 6.10    #机械臂底盘中心到第二个舵机中心轴的距离6.10cm 6.4
    # l2 = 10.16   #第二个舵机到第三个舵机的距离10.16cm 10.048
    # l3 = 9.64    #第三个舵机到第四个舵机的距离9.64cm 9.4714
    # l4 = 0.00    #这里不做具体赋值，根据初始化时的选择进行重新赋值 16.331
    #
    l1 = 6.4
    l2 = 10.048
    l3 = 9.4714
