...
if __name__ == '__main__':
    ...
    test_ok(x, y, z)
    print('done')
    # # valid, j1, j2, j3, j4 = _xyz_to_j123(0, 0, 5, alpha=180)
    # # print("test", valid, j1, j2, j3, j4)
    # valid, j1, j2, j3, j4 = _xyz_alpha_to_j123(x, y, z, 270)
    # # valid, j1, j2, j3, j4 = _xyz_to_j123(x, y, z, alpha=270)
    # print(valid, j1, j2, j3, j4)
    # valid, x1, y1, z1 = forward_kinematics(90, 66, 44, -29)
    # print(valid, x1, y1, z1)
